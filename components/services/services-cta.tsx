          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-8 text-white/72">
                Request setup, support, training or deployment services through SIT Digital Access.
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row lg:justify-end">
              ...
              <Link
                href="/devices"
                className="inline-flex min-h-12 items-center justify-center rounded-full border border-white/30 px-6 text-sm font-semibold text-white transition hover:border-flame-300 hover:bg-white/10"
              >
                Request Devices
              </Link>
              <Link
